/*
DuckDB Parser Grammar
Based on PostgreSQL grammar (DuckDB is PostgreSQL-compatible with extensions)
Original PostgreSQL grammar: https://github.com/antlr/grammars-v4/blob/master/sql/postgresql/PostgreSQLParser.g4
