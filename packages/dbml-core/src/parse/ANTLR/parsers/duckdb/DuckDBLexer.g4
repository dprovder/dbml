/*
DuckDB Lexer Grammar
Based on PostgreSQL grammar (DuckDB is PostgreSQL-compatible with extensions)
Original PostgreSQL grammar: https://github.com/antlr/grammars-v4/blob/master/sql/postgresql/PostgreSQLLexer.g4

Extended for DuckDB-specific features:
...
// DuckDB-specific: Complex data types
STRUCT
   : 'STRUCT'
   ;
...
// DuckDB-specific: 128-bit integer
HUGEINT
   : 'HUGEINT'
   ;
